...
enum class PokemonType(val displayName: String, val rgb: Int) {
    ...
    NOTHING("nothing", 0x777777);

    companion object {
        private val map = values().associateBy(PokemonType::displayName)
        fun fromName(type: String) = map[type]
    }
}
